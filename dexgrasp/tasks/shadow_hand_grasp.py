...
class ShadowHandGrasp(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        # shadow_hand_start_pose.r = gymapi.Quat().from_euler_zyx(3.14, 0, 0)  # gymapi.Quat().from_euler_zyx(0, -1.57, 0)
        ...
        # self.goal_displacement = gymapi.Vec3(-0., 1.0, 0.2)
        # self.goal_displacement = gymapi.Vec3(-0., 0.0, 0.8)
        ...
        goal_start_pose.p.z -= 0.0 # I really don't know why this is needed

        table_pose = gymapi.Transform()
        table_pose.p = gymapi.Vec3(0.0, 0.0, 0.5 * table_dims.z)
        # table_pose.p = gymapi.Vec3(0.0, 0.0, table_dims.z)
